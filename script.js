...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: <a target="_blank" href="https://dibash.com">dibash</a>  | How To Use: <a target="_blank" href="https://dibash.com/edpuzzle">dibash.com/edpuzzle</a>
  <p style="font-size: 12px">Note: This is for educational purposes, This is not used to abuse the Edpuzzle API</p>
  <p style="font-size: 12px">If you use this script you support skibidi toilet and are a sigma! also huge thanks to ading2210  <i> There will be an update where Open Ended Questions will done by complete AI's so stay tuned. </i></p>`;
