...
var validKeys = ["key1", "key2", "key3"]; // Replace these with your valid keys
...
function init() {
    var enteredKey = prompt("Please enter your access key:");
    if (!enteredKey || !validKeys.includes(enteredKey)) {
